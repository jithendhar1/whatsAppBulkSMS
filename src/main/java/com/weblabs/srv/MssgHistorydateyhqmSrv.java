...
@WebServlet("/MssgHistorydateyhqmSrv")
public class MssgHistorydateyhqmSrv extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<MessageHistoryBean> transactions = MessageHistoryDAO.getdateYHQM(Date);
